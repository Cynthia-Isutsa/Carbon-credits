...
export async function getRoutes() {
  const routes = {"1":{"path":"/user","layout":false,"id":"1"},"2":{"path":"/user/login","layout":false,"name":"login","parentId":"1","id":"2"},"3":{"path":"/user","redirect":"/user/login","parentId":"1","id":"3"},"4":{"name":"register-result","icon":"smile","path":"/user/register-result","parentId":"1","id":"4"},"5":{"name":"register","icon":"smile","path":"/user/register","parentId":"1","id":"5"},"6":{"path":"/user/*","parentId":"1","id":"6"},"7":{"path":"/general","name":"General","icon":"dashboard","parentId":"ant-design-pro-layout","id":"7"},"8":{"path":"/general","redirect":"/general/profile","parentId":"7","id":"8"},"9":{"name":"Profile","icon":"smile","path":"/general/profile","parentId":"7","id":"9"},"10":{"name":"Projects","icon":"smile","path":"/general/projects","parentId":"7","id":"10"},"11":{"name":" Users","icon":"smile","path":"/general/users","parentId":"7","id":"11"},"12":{"name":" Settings","icon":"smile","path":"/general/settings","parentId":"7","id":"12"},"13":{"path":"/credits","icon":"form","name":"Credits","parentId":"ant-design-pro-layout","id":"13"},"14":{"path":"/credits","redirect":"/credits/transactions","parentId":"13","id":"14"},"15":{"name":"Transactions","icon":"smile","path":"/credits/transactions","parentId":"13","id":"15"},"16":{"name":"Inventory","icon":"smile","path":"/credits/inventory","parentId":"13","id":"16"},"17":{"name":"Retirements","icon":"smile","path":"/credits/retirements","parentId":"13","id":"17"},"18":{"name":"WareHouse","icon":"smile","path":"/credits/wareHouse","parentId":"13","id":"18"},"19":{"path":"/","redirect":"/general/profile","parentId":"ant-design-pro-layout","id":"19"},"20":{"path":"/*","parentId":"ant-design-pro-layout","id":"20"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true},"umi/plugin/openapi":{"path":"/umi/plugin/openapi","id":"umi/plugin/openapi"}} as const;
  return {
    routes,
    routeComponents: {
...
'15': React.lazy(() => import(/* webpackChunkName: "p__Credits__Transactions__index" */'@/pages/Credits/Transactions/index.tsx')),
'16': React.lazy(() => import(/* webpackChunkName: "p__Credits__Inventory__index" */'@/pages/Credits/Inventory/index.tsx')),
'17': React.lazy(() => import(/* webpackChunkName: "p__Credits__Retirements__index" */'@/pages/Credits/Retirements/index.tsx')),
