...
var ProTable = function ProTable(props) {
  ...
  (0, _proUtils.useDeepCompareEffect)(function () {
    ...
    if (props.request && !(0, _lodashEs.isEmpty)(params) && action.dataSource && !(0, _lodashEs.isEqual)(action.dataSource, defaultData) && (action === null || action === void 0 || (_action$pageInfo = action.pageInfo) === null || _action$pageInfo === void 0 ? void 0 : _action$pageInfo.current) !== 1) {
      action.setPageInfo({
        current: 1
      });
    }
