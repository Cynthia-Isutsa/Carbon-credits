  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        name: 'Inventory',
        icon: 'smile',
        path: '/credits/inventory',
        component: './Credits/Inventory',
      },
      {
        name: 'Retirements',
        icon: 'smile',
        path: '/credits/retirements',
        component: './Credits/Retirements',
      },
      {
        name: 'WareHouse',
        icon: 'smile',
        path: '/credits/wareHouse',
        component: './Credits/WareHouse',
      },
    ],
  },
  {
